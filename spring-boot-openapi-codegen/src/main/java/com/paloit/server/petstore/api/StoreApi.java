...
public interface StoreApi {
    ...
    default ResponseEntity<Void> deleteOrder(@Parameter(name = "orderId", description = "ID of the order that needs to be deleted", required = true) @PathVariable("orderId") Long orderId
    ...
    default ResponseEntity<Order> getOrderById(@Parameter(name = "orderId", description = "ID of order that needs to be fetched", required = true) @PathVariable("orderId") Long orderId
